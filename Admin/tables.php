                                            ...
                                            foreach ($products as $key => $product) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 220px  !important;">
                                                        ...
                                                        <a href="./new1view.php?id=<?= $product->id ?>" style="padding: 5px 8px 5px 8px;" class="btn btn-outline-warning">View</a>
                                                        <a href="/admin/NewEdit.php?id=<?= $product->id ?>"  style="padding: 5px 8px 5px 8px;" class="btn btn-outline-success">Edit</a>
                                                        <a href="./admin/NewDelete.php?id=<?= $product->id ?>" style="padding: 5px 8px 5px 8px;" class="btn btn-outline-danger">Delete</a>
                                                    </td>
                                                </tr>
                                            <?php }
                                        } ?>
