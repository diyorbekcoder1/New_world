  ...
  <div class="d-flex align-items-stretch">
    ...
    <nav id="sidebar">
      ...
      <ul class="list-unstyled">
        <li style="color:wheat"; class="active"><a href="../index.php"> <i class="icon-home"></i>WorldVision </a></li>
        <li><a href="adminRegister.php"> <i class="icon-padnote"></i>RegisterAdmin </a></li>
      ...
      <div class="page-content">
          <div class="page-header">
              <div class="container-fluid">
                  <h2 style="color: wheat" class="h5 no-margin-bottom">World Vision</h2>
              </div>
          </div>
              ...
              <div class="container-fluid">
                  <div class="row">
                      <div class="col-lg-4">
                          <div class="user-block block text-center">
                              ...
                              <div class="contributions active btn btn-success">950 Contributions</div>
                      ...
                      <div class="col-lg-4">
                          <div class="user-block block text-center">
                              ...
                              <div class="contributions active btn btn-success">772 Contributions</div>
                              <div class="details d-flex">
                      ...
                      <div class="col-lg-4">
                          <div class="user-block block text-center">
                              ...
                              <div class="contributions active btn btn-success">620 Contributions</div>
                              <div class="details d-flex">
                                  <div class="item"><i class="icon-info"></i><strong>150</strong></div>
                  ...
                  <div class="public-user-block block">
                      <div class="row d-flex align-items-center">
                          ...
                          <div class="col-lg-4 text-center">
                              <div  class="contributions  btn btn-primary " >410 Contributions</div>
                          </div>
                          <div class="col-lg-4">
                              <div class="details d-flex">
                  ...
                  <div class="public-user-block block">
                      <div class="row d-flex align-items-center">
                          ...
                          <div class="col-lg-4 text-center">
                              <div class="contributions btn btn-primary">320 Contributions</div>
                          </div>
                          <div class="col-lg-4">
                              <div class="details d-flex">
                                  <div class="item"><i class="icon-info"></i><strong>150</strong></div>
                  ...
                  <div class="public-user-block block">
                      <div class="row d-flex align-items-center">
                          ...
                          <div class="col-lg-4 text-center">
                              <div class="contributions btn btn-primary">170 Contributions</div>
                          </div>
                          <div class="col-lg-4">
                              <div class="details d-flex">
                  ...
                  <div class="row d-flex align-items-stretch">
                      <div class="col-lg-4">
                          <div class="stats-with-chart-1 block">
                              ...
                              <div class="row d-flex align-items-end justify-content-between">
                                  <div class="col-5">
                                      <div class="text"><strong class="d-block dashtext-3">$740</strong><span class="d-block">May 2020</span><small class="d-block">320 Sales</small></div>
                                  </div>
                                  <div class="col-7">
                      ...
                      <div class="col-lg-4">
                          <div class="stats-with-chart-1 block">
                              ...
                              <div class="row d-flex align-items-end justify-content-between">
                                  <div class="col-4">
                                      <div class="text"><strong class="d-block dashtext-1">$457</strong><span class="d-block">May 2021</span><small class="d-block">210 Sales</small></div>
                                  </div>
                                  <div class="col-8">
                                      <div class="bar-chart chart">
                      ...
                      <div class="col-lg-4">
                          <div class="stats-with-chart-1 block">
                              ...
                              <div class="row d-flex align-items-end justify-content-between">
                                  <div class="col-5">
                                      <div class="text"><strong class="d-block dashtext-2">80%</strong><span class="d-block">May 2022</span><small class="d-block">+35 Sales</small></div>
                                  </div>
                                  <div class="col-7">
                                      <div class="bar-chart chart">
